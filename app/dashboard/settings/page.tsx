...
const areHoursDisabled = restaurant.subscription_plan !== 'light' && restaurant.always_open;
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 pb-24 px-4 pt-24 md:pt-10 animate-in fade-in duration-500">
      ...
      {/* CONTENIDO DE TABS */}
      <div className={`${settingsTab === 'impresoras' ? 'w-full' : 'max-w-2xl'} space-y-6`}>
            ...
            {restaurant.subscription_plan !== 'light' && (
              <section className="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm">
                <div className="grid grid-cols-1 md:grid-cols-[3fr_2fr]">
                  ...
                  {/* Columna derecha: solo el video, oculto en mobile */}
                  <div className="hidden md:flex items-stretch overflow-hidden rounded-r-[2.5rem] p-4">
                    <video

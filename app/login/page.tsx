...
export default function LoginPage() {
  ...
  return (
    <div className="flex h-screen w-full bg-white overflow-hidden">
      ...
      <div className="w-full lg:w-[35%] xl:w-[30%] flex flex-col justify-center px-8 md:px-12 lg:px-16 overflow-y-auto py-10 text-gray-900">
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            {isRegistering && (
                <div className="space-y-4 animate-in slide-in-from-top-2 fade-in duration-300">
                    ...
                    <div>
                        <label className="block text-xs font-bold text-gray-700 uppercase mb-1">WhatsApp Personal</label>
                        <div className="relative">
                            ...
                            <input 
                                ...
                                className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl outline-none focus:border-black transition font-bold"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl outline-none focus:border-black transition"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-10 pr-10 py-3 border border-gray-200 rounded-xl outline-none focus:border-black transition"
                  placeholder="••••••••"
                  required
                />
                <button
            ...
            {message && (
              <div className={`p-3 rounded-lg text-sm font-bold ${message.includes('creada') || message.includes('enviamos') ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-600'}`}>
                {message}
              </div>
            )}
